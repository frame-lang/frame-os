...
|---|---|---|---|
| [`Shell` (hosted variant)](shell.md) | H0–H3 | In progress (H0) | Top-level shell lifecycle: prompt, parse, run, repeat. State-dependent signal handling. |
| `Parser` | H1 | Planned | Tokenizes a command line into structured commands. Handles quoting, escaping, whitespace. |
