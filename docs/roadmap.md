...
- **Remaining:** Step 4b (passive handshake, hostfwd + harness TCP client) → 4c (data echo) → 4d (close + TIME_WAIT timer wheel) = **B5-4**; 4e (active open via guestfwd + retransmit); 4f (docs/CI = B5-6/-7). See [`plans/b5_tcp.md`](plans/b5_tcp.md). ICMP responder (B5-3) rides the TAP upgrade.
