...
- **Remaining (Step 2b):** IPv4 + ICMP — the kernel pings the gateway (ICMP echo client) over slirp (B5-3's responder direction needs inbound ICMP, which arrives with TAP). Then UDP (Step 3), TCP (Step 4).
