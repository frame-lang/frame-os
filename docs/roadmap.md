...
- **Remaining:** Step 4e (active open via slirp `guestfwd` + retransmit behavioral); Step 4f (the `TcpConnection`-vs-RFC-793 write-up = B5-6, CI = B5-7). See [`plans/b5_tcp.md`](plans/b5_tcp.md). ICMP responder (B5-3) rides the TAP upgrade.
